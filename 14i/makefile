...
nmon_mainframe_sles11: $(FILE)
        cc -o nmon_mainframe_sles11 $(FILE) $(CFLAGS) $(LDFLAGS) -D MAINFRAME
...
nmon_x86_64_debian:  $(FILE)
        cc -o nmon_x86_debian $(FILE) $(CFLAGS) $(LDFLAGS) -D X86
